...
## Rules
A table which associates MIME types to file extensions is provided. You are also given a list of names of files to be transferred and for each one of these files, you must find the MIME type to be used.
